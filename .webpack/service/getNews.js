...
var newsapi = new NewsAPI('4241ab4846a24b608a14e933dc323eb1'); // To query /v2/top-headlines
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log("event:::", event);
            console.log('context::::', context); // const { sources, q, category, language, country } = JSON.parse(event.params);
            // const { country } = JSON.parse(event.params);

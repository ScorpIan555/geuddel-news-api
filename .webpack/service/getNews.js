...
function _main() {
  ...
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(event, context) {
    var reqQuery, sources, q, category, language, country, news;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            reqQuery = event.queryStringParameters; // const queryPathData = event.pathParameters;
            ...
            sources = reqQuery.sources, q = reqQuery.q, category = reqQuery.category, language = reqQuery.language, country = reqQuery.country;
            console.log('reqQuery:::', reqQuery); // console.log('query path parameters', queryPathData);
